...
function serializePositiveInteger(value) {
  const numericValue =
    typeof value === "string"
      ? Number(value)
      : typeof value === "number"
  ...
  return {
    ...
    attachments: deleted
      ...
      : Array.isArray(message?.attachments)
        ...
        : [],
    voiceMessage: deleted
      ? ""
      : typeof message?.voiceMessage === "string"
        ? message.voiceMessage
        : "",
    voiceDurationMs: deleted ? 0 : serializePositiveInteger(message?.voiceDurationMs),
