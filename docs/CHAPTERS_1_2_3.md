...
- **Invoice Generation:** Itemized digital invoices with item name, quantity, unit price, optional item photos, and provider-applied discounts. Delivery charges are computed during invoice payment and stored on the resulting order. Customer review with approve/reject workflow.
