            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <p className="max-w-md text-sm text-muted-foreground md:text-base">
                  Add your business details, pricing, and service area so
                  seekers can discover and book you with upfront, escrow‑backed
                  payments.
                </p>
              </div>
              ...
              <header className="mb-6 flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    We use this information to show seekers who you are and
                    where you operate.
                  </p>
                </div>
                ...
                <fieldset className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        className="w-full rounded-xl border bg-background px-4 py-2.5 pr-10 text-sm shadow-sm outline-none ring-0 transition focus:border-sky-500 focus:ring-2 focus:ring-sky-100 cursor-text"
                        type="password"
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        min="1"
                        max="100"
                        placeholder="How many km will you cover?"
                        value={form.radius_km}
                        onChange={(e) => set("radius_km", e.target.value)}
                        required
                      />
                      <p className="text-[11px] text-muted-foreground">
                        Maximum distance you&apos;ll travel from your location
                      </p>
                    </div>
                  </div>
                </fieldset>
