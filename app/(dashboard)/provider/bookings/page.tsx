    ...
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-xl p-6">
          ...
          <div className="text-3xl font-bold text-foreground mt-2">{pending.length}</div>
        </div>
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="text-sm font-medium text-muted-foreground">Accepted</div>
          <div className="text-3xl font-bold text-foreground mt-2">{accepted.length}</div>
        </div>
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="text-sm font-medium text-muted-foreground">Completed</div>
          <div className="text-3xl font-bold text-foreground mt-2">{completed.length}</div>
        </div>
      </div>
