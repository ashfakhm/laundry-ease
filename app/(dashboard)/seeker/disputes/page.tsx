      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage and track your open support cases.
          </p>
        </div>
      </div>
      ...
      {disputes.length === 0 ? (
        <div className="rounded-3xl border border-border/50 bg-card/40 p-12 text-center backdrop-blur-xl">
          ...
          <p className="mt-2 text-muted-foreground">
            Everything looks good! You have no open issues.
          </p>
          <Link
            href="/seeker/bookings"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3 font-semibold text-primary-foreground hover:bg-primary/90 transition-colors"
          >
            View Bookings
          </Link>
        </div>
