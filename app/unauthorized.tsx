...
export default function Unauthorized() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center gap-6 text-center px-4 py-12">
      <div className="rounded-3xl border bg-card/80 p-8 md:p-12 shadow-lg backdrop-blur max-w-lg w-full">
        ...
        <h1 className="mt-6 text-4xl font-bold tracking-tight">401</h1>
