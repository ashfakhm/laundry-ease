      ...
      <header className="fixed top-0 left-0 right-0 z-50 border-b border-border/40 bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
            <Link href="#features" className="hover:text-primary hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.5)] transition-all duration-300">Features</Link>
            <Link href="#how-it-works" className="hover:text-primary hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.5)] transition-all duration-300">How it Works</Link>
            <Link href="#pricing" className="hover:text-primary hover:drop-shadow-[0_0_8px_rgba(45,212,191,0.5)] transition-all duration-300">Pricing</Link>
          </nav>
          <div className="flex items-center gap-4">
            ...
            <Link href="/choose-role">
              <button className="h-9 px-4 bg-primary text-primary-foreground text-sm font-medium rounded-md hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(45,212,191,0.4)] hover:shadow-[0_0_30px_rgba(45,212,191,0.6)] hover:translate-y-[-1px]">
                Get Started
              </button>
            </Link>
          </div>
      ...
      <main className="flex-1 pt-24 relative">
          ...
          <div className="container mx-auto max-w-5xl relative z-10 pointer-events-auto">
            ...
            >
              ...
              <h1 className="font-heading text-5xl md:text-7xl font-bold tracking-tight text-foreground leading-[1.1] drop-shadow-sm">
                Laundry, <span className="text-primary italic drop-shadow-[0_0_15px_rgba(45,212,191,0.4)]">solved</span> <br/> for the modern professional.
              </h1>
              
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                Doorstep pickup, deadline-guaranteed delivery, and payment only upon satisfaction. 
                Experience the future of laundry with our tech-enabled fleet.
              </p>
        ...
        <section id="features" className="px-6 py-24 relative z-10">
          <div className="container mx-auto max-w-6xl">
            ...
            >
              <FeatureCard 
                icon={<Clock className="w-6 h-6 text-primary drop-shadow-[0_0_8px_rgba(45,212,191,0.6)]" />}
              ...
              />
              <FeatureCard 
                icon={<ShieldCheck className="w-6 h-6 text-primary drop-shadow-[0_0_8px_rgba(45,212,191,0.6)]" />}
                title="Escrow Protection"
                description="Your payment is held in a secure tech-escrow smart contract until you verify the delivery via OTP."
                delay={0.3}
              />
              <FeatureCard 
                icon={<MapPin className="w-6 h-6 text-primary drop-shadow-[0_0_8px_rgba(45,212,191,0.6)]" />}
        ...
        {/* Workflow Section */}
        <section id="how-it-works" className="px-6 py-24 bg-card/30 border-y border-border/50 backdrop-blur-sm">
          <div className="container mx-auto max-w-5xl">
            <div className="mb-16 text-center">
              <h2 className="font-heading text-3xl font-bold mb-4">How it works</h2>
              <p className="text-muted-foreground">Automated workflow from request to delivery.</p>
            </div>
            ...
            <div className="relative border-l border-primary/20 ml-4 md:ml-0 md:pl-0 space-y-16">
               <WorkflowStep 
                 number="01"
                 title="Book & Schedule"
                 description="Select a provider. Algorithm matches based on throughput statistics and rating. Secure slot with a deposit."
               />
               <WorkflowStep 
                 number="02"
                 title="Pickup & Invoice"
                 description="Provider digitizes your inventory on-site. You approve the generated invoice instantly."
               />
               <WorkflowStep 
                 number="03"
                 title="Track & Release"
                 description="Watch the status update in real-time. Upon delivery validation, the escrow automatically releases funds."
               />
            </div>
          </div>
        </section>
      ...
      <footer className="py-12 px-6 border-t border-border bg-background">
        <div className="container mx-auto max-w-6xl flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading font-semibold text-sm">LaundryEase</span>
          </div>
  ...
  return (
    ...
    >
      <SpotlightCard className="h-full p-8 rounded-2xl bg-card/50 backdrop-blur-sm border-primary/10 hover:border-primary/30 transition-colors">
        ...
        <h3 className="font-heading text-xl font-bold mb-3 tracking-tight">{title}</h3>
  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 md:text-right md:pr-12">
        <span className="text-xs font-bold text-primary tracking-wider uppercase mb-2 block drop-shadow-[0_0_5px_rgba(45,212,191,0.6)]">Step {number}</span>
        <h3 className="font-heading text-2xl font-bold mb-2">{title}</h3>
      </div>
      <div className="md:w-1/2 md:pl-12 pb-16 md:pb-0 md:ml-0 pl-8 md:pl-12">
         {/* Mobile dot */}
         <div className="md:hidden absolute left-[-6px] top-1 w-3 h-3 bg-background border-[3px] border-primary rounded-full z-10 shadow-[0_0_10px_rgba(45,212,191,0.6)]" />
