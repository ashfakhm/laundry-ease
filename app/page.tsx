...
export default function LandingPage() {
  return (
    <>
      {/* JSON-LD Structured Data for SaaS Service */}
      <JsonLdScript
        data={{
          ...
          provider: {
            "@type": "Organization",
            name: "LaundryEase Inc.",
            url: "https://laundryease.com",
            logo: {
              "@type": "ImageObject",
              url: "https://laundryease.com/laundryease-logo.png",
              width: 64,
              height: 64,
            },
          },
          areaServed: ["New York", "San Francisco"],
          serviceType: "Laundry, Pickup, Delivery, Escrow Payment",
          url: "https://laundryease.com",
        }}
